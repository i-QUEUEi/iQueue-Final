      ...
      <div className="flex-1 overflow-y-auto px-8 py-8 space-y-8 pb-8" style={{ fontFamily: "'Product Sans', 'Google Sans', sans-serif" }}>
        ...
        <section>
          <div className="rounded-2xl border border-gray-200 bg-white shadow-sm p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                { name: 'Main Branch', status: 'Operational', visitors: 1247, staff: 12 },
                { name: 'North Branch', status: 'Operational', visitors: 892, staff: 9 },
                { name: 'East Branch', status: 'Slow', visitors: 654, staff: 6 }
              ].map((branch, idx) => (
                <div key={idx} className="rounded-xl border border-green-200 bg-gradient-to-br from-green-50 to-emerald-100 p-6">
